...
{
    public class FornecedorManager : EntityManager<Fornecedor>
    {
        ...
        public override async Task<Command> Add(Command command)
        {
            ...
            try
            {
                ...
                var fornecedores = await MyRepository.Get(t => t.Codigo.Equals(dto.Codigo));
                ...
                if (fornecedores != null && !fornecedores.Any())
                {
                    ...
                    fornecedor.UpdateEntity(dto);
                    await MyRepository.Insert(fornecedor);
        ...
        public override async Task<Command> Edit(Command command)
        {
            ...
            try
            {
                ...
                var fornecedor = await MyRepository.GetById(cmd.EntityId);
