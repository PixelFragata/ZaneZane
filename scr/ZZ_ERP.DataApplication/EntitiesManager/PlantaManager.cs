...
{
    public class PlantaManager : EntityManager<Planta>
    {
        ...
        public override async Task<Command> Add(Command command)
        {
            ...
            try
            {
                ...
                var plantas = await MyRepository.Get(t => t.Codigo.Equals(dto.Codigo));
        ...
        public override async Task<Command> Edit(Command command)
        {
            ...
            try
            {
                ...
                var planta = await MyRepository.GetById(cmd.EntityId);

                if (planta != null)
                {
                    planta.UpdateEntity(dto);
